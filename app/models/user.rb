class User < ActiveRecord::Base
  ...
  #validates :nickname, presence: true, format: /\A[a-z0-9]+\Z/i, length: { in: 1..17 } #, if: "user_type_id==2"
  validates :nickname, presence: true, length: {minimum: APIConstants::USER::NICKNAME_LENGTH_MIN,
    maximum: APIConstants::USER::NICKNAME_LENGTH_MAX } #, if: "user_type_id==2"
  validates :bio, length: { minimum: APIConstants::USER::BIO_LENGTH_MIN,
    maximum: APIConstants::USER::BIO_LENGTH_MAX }
  ...
  validates :hometown, length: { minimum: APIConstants::USER::HOMETOWN_LENGTH_MIN,
